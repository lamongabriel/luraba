...
type LabelEntity = Pick<Category, "name" | "icon" | "color"> | Pick<Tag, "name" | "icon" | "color">;
...
export function UncategorizedChip({ variant = "default" }: { variant?: "default" | "compact" }) {
  return (
    <Badge
      variant="outline"
      className={cn(variant === "compact" && "h-5 rounded-md px-1.5 text-[0.65rem]")}
    >
