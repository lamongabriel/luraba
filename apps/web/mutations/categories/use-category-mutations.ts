...
export function useCreateCategoryMutation<TContext = unknown>(
  options?: UseAppMutationOptions<CreateCategoryResponse, CreateCategoryBody, TContext>,
) {
...
export function useUpdateCategoryMutation<TContext = unknown>(
  options?: UseAppMutationOptions<UpdateCategoryResponse, UpdateCategoryVariables, TContext>,
) {
  return useAppMutation(updateCategoryMutationDefinition, options);
}

export const deleteCategoryMutationDefinition = createAppMutationDefinition<void, string>({
