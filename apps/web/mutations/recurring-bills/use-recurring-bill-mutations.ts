...
type CreateRecurringBillResponse = Awaited<ReturnType<typeof createRecurringBill>>;
type UpdateVariables = {
  id: string;
  body: Parameters<typeof updateRecurringBill>[1];
};
type UpdateRecurringBillResponse = Awaited<ReturnType<typeof updateRecurringBill>>;

export const createRecurringBillMutationDefinition = createAppMutationDefinition<
...
export function useCreateRecurringBillMutation<TContext = unknown>(
  options?: UseAppMutationOptions<CreateRecurringBillResponse, CreateRecurringBillBody, TContext>,
) {
  return useAppMutation(createRecurringBillMutationDefinition, options);
}
export const updateRecurringBillMutationDefinition = createAppMutationDefinition<
...
export function useUpdateRecurringBillMutation<TContext = unknown>(
  options?: UseAppMutationOptions<UpdateRecurringBillResponse, UpdateVariables, TContext>,
) {
  return useAppMutation(updateRecurringBillMutationDefinition, options);
}
export const deleteRecurringBillMutationDefinition = createAppMutationDefinition<void, string>({
...
export const skipRecurringOccurrenceMutationDefinition = createAppMutationDefinition<
  void,
  OccurrenceVariables
>({
...
export const rescheduleRecurringOccurrenceMutationDefinition = createAppMutationDefinition<
  void,
...
export function useRescheduleRecurringOccurrenceMutation<TContext = unknown>(
  options?: UseAppMutationOptions<void, { id: string; date: string; nextDate: string }, TContext>,
) {
  return useAppMutation(rescheduleRecurringOccurrenceMutationDefinition, options);
}
export const createRecurringOccurrenceMutationDefinition = createAppMutationDefinition<
  unknown,
  OccurrenceVariables
>({
