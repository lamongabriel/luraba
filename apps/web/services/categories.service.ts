...
export function listCategories(query: ListCategoriesQuery = {}): Promise<ListCategoriesResult> {
  return requestContract(categoriesEndpoints.list, { query });
}

export function createCategory(input: CreateCategoryInput): Promise<CreateCategoryResult> {
