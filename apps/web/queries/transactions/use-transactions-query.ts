...
import type { ListTransactionsQuery, ListTransactionsResult } from "@luraba/contracts";
...
export const transactionQueryKeys = {
  ...
  list: (filters: ListTransactionsQuery) => [...transactionQueryKeys.lists(), filters] as const,
};
