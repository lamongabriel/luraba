...
export function useCreateHouseholdMutation<TContext = unknown>(
  options?: UseAppMutationOptions<CreateHouseholdResult, CreateHouseholdInput, TContext>,
) {
...
export function useUpdateHouseholdMutation<TContext = unknown>(
  options?: UseAppMutationOptions<UpdateHouseholdResult, UpdateHouseholdVariables, TContext>,
) {
...
export const updateHouseholdMemberMutationDefinition = createAppMutationDefinition<
  UpdateHouseholdMemberResult,
  UpdateMemberVariables
>({
  defaultErrorMessage: "We couldn't update this household member. Please try again.",
  mutationFn: ({ householdId, userId, body }) => updateHouseholdMember(householdId, userId, body),
  mutationKey: ["households", "members", "update"],
});

export function useUpdateHouseholdMemberMutation<TContext = unknown>(
  options?: UseAppMutationOptions<UpdateHouseholdMemberResult, UpdateMemberVariables, TContext>,
) {
...
export const removeHouseholdMemberMutationDefinition = createAppMutationDefinition<
  RemoveHouseholdMemberResult,
  HouseholdMemberVariables
>({
  defaultErrorMessage: "We couldn't remove this household member. Please try again.",
  mutationFn: ({ householdId, userId }) => removeHouseholdMember(householdId, userId),
  mutationKey: ["households", "members", "remove"],
});

export function useRemoveHouseholdMemberMutation<TContext = unknown>(
  options?: UseAppMutationOptions<RemoveHouseholdMemberResult, HouseholdMemberVariables, TContext>,
) {
...
export const createHouseholdInviteMutationDefinition = createAppMutationDefinition<
  CreateHouseholdInviteResult,
  CreateInviteVariables
>({
  defaultErrorMessage: "We couldn't create this invitation. Please try again.",
  mutationFn: ({ householdId, body }) => createHouseholdInvite(householdId, body),
  mutationKey: ["households", "invites", "create"],
});

export function useCreateHouseholdInviteMutation<TContext = unknown>(
  options?: UseAppMutationOptions<CreateHouseholdInviteResult, CreateInviteVariables, TContext>,
) {
...
export const refreshHouseholdInviteLinkMutationDefinition = createAppMutationDefinition<
  RefreshHouseholdInviteLinkResult,
  InviteVariables
>({
  defaultErrorMessage: "We couldn't refresh this invitation link. Please try again.",
  mutationFn: ({ householdId, inviteId }) => refreshHouseholdInviteLink(householdId, inviteId),
  mutationKey: ["households", "invites", "refresh-link"],
});

export function useRefreshHouseholdInviteLinkMutation<TContext = unknown>(
  options?: UseAppMutationOptions<RefreshHouseholdInviteLinkResult, InviteVariables, TContext>,
) {
  return useAppMutation(refreshHouseholdInviteLinkMutationDefinition, options);
}

export const resendHouseholdInviteMutationDefinition = createAppMutationDefinition<
  ResendHouseholdInviteResult,
  InviteVariables
>({
  defaultErrorMessage: "We couldn't resend this invitation. Please try again.",
  mutationFn: ({ householdId, inviteId }) => resendHouseholdInvite(householdId, inviteId),
  mutationKey: ["households", "invites", "resend"],
});

export function useResendHouseholdInviteMutation<TContext = unknown>(
  options?: UseAppMutationOptions<ResendHouseholdInviteResult, InviteVariables, TContext>,
) {
  return useAppMutation(resendHouseholdInviteMutationDefinition, options);
}

export const cancelHouseholdInviteMutationDefinition = createAppMutationDefinition<
  CancelHouseholdInviteResult,
  InviteVariables
>({
  defaultErrorMessage: "We couldn't cancel this invitation. Please try again.",
  mutationFn: ({ householdId, inviteId }) => cancelHouseholdInvite(householdId, inviteId),
  mutationKey: ["households", "invites", "cancel"],
});

export function useCancelHouseholdInviteMutation<TContext = unknown>(
  options?: UseAppMutationOptions<CancelHouseholdInviteResult, InviteVariables, TContext>,
) {
...
export const acceptHouseholdInviteMutationDefinition = createAppMutationDefinition<
  AcceptHouseholdInviteResult,
  InviteTokenVariables
>({
  defaultErrorMessage: "We couldn't accept this invitation. Please try again.",
  mutationFn: ({ token }) => acceptHouseholdInvite({ token } satisfies AcceptHouseholdInviteInput),
  mutationKey: ["households", "invites", "accept"],
});

export function useAcceptHouseholdInviteMutation<TContext = unknown>(
  options?: UseAppMutationOptions<AcceptHouseholdInviteResult, InviteTokenVariables, TContext>,
) {
  return useAppMutation(acceptHouseholdInviteMutationDefinition, options);
}

export const acceptHouseholdInviteByIdMutationDefinition = createAppMutationDefinition<
  AcceptHouseholdInviteByIdResult,
  string
>({
  defaultErrorMessage: "We couldn't accept this invitation. Please try again.",
...
export function useAcceptHouseholdInviteByIdMutation<TContext = unknown>(
  options?: UseAppMutationOptions<AcceptHouseholdInviteByIdResult, string, TContext>,
) {
  return useAppMutation(acceptHouseholdInviteByIdMutationDefinition, options);
}

export const rejectHouseholdInviteByIdMutationDefinition = createAppMutationDefinition<
  RejectHouseholdInviteByIdResult,
  string
>({
  defaultErrorMessage: "We couldn't decline this invitation. Please try again.",
...
export function useRejectHouseholdInviteByIdMutation<TContext = unknown>(
  options?: UseAppMutationOptions<RejectHouseholdInviteByIdResult, string, TContext>,
) {
  return useAppMutation(rejectHouseholdInviteByIdMutationDefinition, options);
}

export const rejectHouseholdInviteMutationDefinition = createAppMutationDefinition<
  RejectHouseholdInviteResult,
  InviteTokenVariables
>({
  defaultErrorMessage: "We couldn't reject this invitation. Please try again.",
  mutationFn: ({ token }) => rejectHouseholdInvite({ token } satisfies AcceptHouseholdInviteInput),
  mutationKey: ["households", "invites", "reject"],
});

export function useRejectHouseholdInviteMutation<TContext = unknown>(
  options?: UseAppMutationOptions<RejectHouseholdInviteResult, InviteTokenVariables, TContext>,
) {
