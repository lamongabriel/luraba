...
type ColorFormItemProps<TFieldValues extends FieldValues> = BaseFormItemProps<TFieldValues> & {
  type: "color";
...
type IconFormItemProps<TFieldValues extends FieldValues> = BaseFormItemProps<TFieldValues> & {
  type: "icon";
...
type CategoryFormItemProps<TFieldValues extends FieldValues> = BaseFormItemProps<TFieldValues> & {
  type: "category";
...
type TagFormItemProps<TFieldValues extends FieldValues> = BaseFormItemProps<TFieldValues> & {
  type: "tag";
  triggerClassName?: string;
};
          ...
          <Field data-invalid={hasError} className={className}>
            ...
            {props.type === "select" && (
              <Select
                ...
                onValueChange={(value) => field.onChange(props.parseValue?.(value) ?? value)}
                disabled={disabled}
              >
                <SelectTrigger
                  id={inputId}
