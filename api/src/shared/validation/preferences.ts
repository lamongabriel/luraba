...
export const TIMEZONE_VALUES = preferredTimezoneEnum.enumValues;
...
export const COUNTRY_CODE_VALUES = countryCodeEnum.enumValues;
...
export const countryCodeSchema = z.enum(countryCodeEnum.enumValues);
