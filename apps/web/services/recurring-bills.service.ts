...
export function deleteRecurringBill(id: string): Promise<DeleteRecurringBillResult> {
...
export function skipRecurringOccurrence(id: string, date: string): Promise<SkipOccurrenceResult> {
