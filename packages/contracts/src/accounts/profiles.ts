...
import { countryCodeSchema } from "../preferences.js";
import {
...
export type CreateAccountProfile = z.output<typeof createAccountProfileSchema>;
export type UpdateAccountProfile = z.output<typeof updateAccountProfileSchema>;
