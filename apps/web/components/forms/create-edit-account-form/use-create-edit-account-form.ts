...
export function useCreateEditAccountForm({
  ...
  React.useEffect(() => {
    ...
    form.reset(
      getCreateEditAccountDefaultValues(defaultCurrencyCode, accountType, account, precision),
    );
  ...
  React.useEffect(() => {
    ...
    form.reset({
      ...getCreateEditAccountDefaultValues(current.currencyCode || defaultCurrencyCode, type),
      name: current.name,
  ...
  const onSubmit = form.handleSubmit((values) => {
    ...
    const currency = currenciesQuery.data?.data.find((item) => item.code === values.currencyCode);
  ...
  return {
    currenciesQuery,
    errorMessage: createAccountMutation.errorMessage || updateAccountMutation.errorMessage,
    form,
    isEdit,
    isPending,
    onSubmit,
