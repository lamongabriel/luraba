...
export function useUpdateTagMutation<TContext = unknown>(
  options?: UseAppMutationOptions<UpdateTagResponse, UpdateTagVariables, TContext>,
) {
  return useAppMutation(updateTagMutationDefinition, options);
}

export const deleteTagMutationDefinition = createAppMutationDefinition<void, string>({
