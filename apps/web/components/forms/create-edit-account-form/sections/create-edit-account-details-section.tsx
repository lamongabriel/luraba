...
export function CreateEditAccountDetailsSection({
  disabled,
  form,
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-4">
        ...
        {type === "crypto" ? (
          <CryptoFormSection form={form} disabled={disabled} />
        ) : null}
        {type === "property" ? (
          <PropertyFormSection form={form} disabled={disabled} />
        ) : null}
        {type === "vehicle" ? (
          <VehicleFormSection form={form} disabled={disabled} />
        ) : null}
        {type === "loan" ? (
          <LoanFormSection form={form} disabled={disabled} />
        ) : null}
      </div>
    </section>
  )
