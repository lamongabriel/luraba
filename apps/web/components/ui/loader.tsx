...
export function Loader({
  ...
  const content = (
    <>
      <div aria-hidden="true" className={cn(loaderSpinnerVariants({ size }), className)} />
  ...
  if (fullPage) {
    return (
      <main
        className={cn("flex min-h-dvh items-center justify-center px-4 py-8", containerClassName)}
      >
        {content}
      </main>
    );
